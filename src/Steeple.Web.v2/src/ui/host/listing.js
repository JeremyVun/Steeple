...
import { renderAvailabilityPanel } from './listing/availability.js';
import { renderDescribePanel } from './listing/describe.js';
import { renderPlacePanel, renderPlacedBlock } from './listing/place.js';
...
export function createListingFlow({ announce, onChanged, onClose, askToSignIn }) {
  ...
  function publishLayout(words) {
    const where = renderPlacedBlock({ L, PIN_SVG, draft, el });
