...
/// <c>web.sign_in_enabled</c>) because the flags SDK's source lives outside this repo — swap the
/// implementation for the SDK client when it lands (ROADMAP Phase 0 leftover). Evaluation must
/// stay local/in-memory either way: never a blocking network call on the request path.
/// </summary>
