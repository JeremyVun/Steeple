...
/// <param name="Url">Full-size image URL/path.</param>
/// <param name="ThumbUrl">400w variant URL/path; null for legacy external photos — fall back to <paramref name="Url"/>.</param>
/// <param name="CardUrl">800w variant URL/path; null for legacy external photos — fall back to <paramref name="Url"/>.</param>
