...
`docs/contracts/seo.md` owns the built crawler surface and its rationale (sitemap, robots, clean
canonical routes, per-listing HTML/meta/OG/JSON-LD, real 404s, and deferred work). Remaining
architecture hooks:
