...
| **Manage** ✅ | provider self-service venue/room CRUD, the single moderation gate (trusted-host rule + published ⇒ venue verified) | `IVenueManagerRepository`, `IManageRepository`, `IGeocodingGateway` |
